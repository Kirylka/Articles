...
default implementations live on `flue-governed-tools/adapters`.
...
```ts
import { HashChainAuditLog } from "flue-governed-tools/audit";
import { textRedactor } from "flue-governed-tools/adapters";
